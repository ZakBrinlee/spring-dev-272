...
const AddRestaurant = () => {
  ...
  const { addRestaurant, restaurants, updateRestaurant } =
          ...
          <Box>
            ...
            <Box className="mb-4">
              <HStack space="md" className="mb-4 items-center">
                <Text size="lg" className="text-stone-900 dark:text-white">
                  Rating (1-5):
                </Text>
                <Text bold size="lg" className="text-stone-900 dark:text-white">
                  {values.rating || 0}
                </Text>
              </HStack>
